...
public class GetMerchantByIdResponse {
    ...
    private domain.merchant.MerchantDomain _return;
     ...
     */
    public domain.merchant.MerchantDomain getReturn() {
        return this._return;
    }
     ...
     */
    public void setReturn(domain.merchant.MerchantDomain _return) {
